        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" action="<?= base_url('user/updateDataKelas'); ?>/<?= $data['id']; ?>" method="post">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="first-name" class="form-control" name="nama" placeholder="Nama Santri" value="<?= $data['namaSantri']; ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Jabatan</label>
                                    </div>
