...
<section style="height:100%; width: 100%; box-sizing: border-box; background-color: #FFFFFF">
    ...
    <div style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="text-center title-text-content-2-2">
            ...
            <p class="text-caption-content-2-2" style="  margin-left: 3rem; margin-right: 3rem;">You can easily manage your business with a powerful tools</p>
        </div>
        ...
        <div class="grid-padding-content-2-2 text-center">
            <div class="row">
                <div class="col-lg-4 column-content-2-2">
                    ...
                    <p class="icon-content-2-2-caption">This can easily help you to<br>
            ...
            <div class="card-content-2-2">
                <div class="d-flex flex-lg-row flex-column align-items-center">
                    ...
                    <div class="flex-grow-1 text-lg-start text-center card-text-content-2-2">
                        ...
                        <p class="d-none d-lg-block card-content-2-2-caption">Our tools for business analysis helps an organization understand<br>
                            market or business development.</p>
                        <p class="d-block d-lg-none card-content-2-2-caption">Our tools for business analysis helps an organization understand
                            market or business development.</p>
                    </div>
    ...
    <div class="main-content-3-2" style="font-family: 'Poppins', sans-serif;">
        <div class="d-flex flex-lg-row flex-column align-items-center">
            ...
            <div class="img-hero-content-3-2 text-center justify-content-center d-flex">
                <img id="hero-content-3-2" class="img-fluid" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content3/Content-3-1.png" alt="">
            </div>
...
<section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #F5F5F5">
    <div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
        <div class="position-relative d-none d-lg-block h-100 width-left-content-3-5">
            <img class="position-absolute img-fluid centered-content-3-5" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Empty%20State/EmptyState3/Empty-3-5.png" alt="">
        </div>
        <div class="d-flex mx-auto align-items-left justify-content-left width-right-content-3-5">
            <div class="right-content-3-5">
                ...
                <p class="caption-text-content-3-5">Please log in using that account has<br>
                ...
                <form style="margin-top: 1.5rem;" action="" method="post">
                    <div style="margin-bottom: 1.75rem;">
                        ...
                        <div class="d-flex w-100 div-input-content-3-5">
                            ...
                            <input class="input-field-content-3-5" type="email" name="" id="" placeholder="Your Email Address" autocomplete="on" required>
                        </div>
                    </div>
                    <div style="margin-top: 1rem;">
                        ...
                        <div class="d-flex w-100 div-input-content-3-5">
                            ...
                            <input class="input-field-content-3-5" type="password" name="" id="" placeholder="Your Password" minlength="6" required>
                            <div>
                    ...
                    <div class="text-right" style="margin-top: 0.75rem;">
                        <a href="#" class="forgot-password-content-3-5 font-italic">Forgot Password?</a>
                    </div>
                    <button class="btn btn-fill-content-3-5 d-block w-100" type="submit">Log In To My Account</button>
                </form>
                <p class="text-center bottom-caption-content-3-5">Don't have an account yet?
                    <span class="green-bottom-caption-content-3-5">Register Here</span>
                </p>
            </div>
        </div>
...
<section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #F2F6FF">
    ...
    <div class="main-content-3-7 overflow-hidden" style="font-family: 'Poppins', sans-serif;">
        <div class="container mx-auto">
            <div class="d-flex flex-column text-center w-100" style="margin-bottom: 2.25rem;">
                <h2 class="title-text-content-3-7">Pricing That Everyone Works</h2>
                <p class="caption-text-content-3-7 mx-auto">Choose one of our friendly pricing that suitable<br>
                    for your business to grow bigger</p>
            </div>
            <div class="d-flex flex-wrap">
                <div class="mx-auto card-content-3-7">
                    <div class="card-outline-content-3-7 d-flex flex-column position-relative overflow-hidden h-100">
                        ...
                        <button class="btn btn-outline-content-3-7 d-flex justify-content-center align-items-center w-100">Choose Plan</button>
                    </div>
                </div>
                <div class="mx-auto card-content-3-7">
                    <div class="card-outline-content-3-7 d-flex flex-column position-relative overflow-hidden h-100">
            ...
            ">
                        ...
                        <p class="price-caption-content-3-7" style="color: #7987A6;">Suitable to make your<br>
                        ...
                        <button class="btn btn-fill-content-3-7 d-flex justify-content-center align-items-center w-100">Choose Plan</button>
                    </div>
                </div>
            </div>
        </div>
