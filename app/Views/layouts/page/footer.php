    ...
    <div style="font-family: 'Poppins', sans-serif;">
        <div class="list-footer-footer-2-3">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="">
                        <div class="list-space-footer-2-3">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROn8mgGoxQS58Kw6ptGNBRxChmQ227D6585Q&usqp=CAU" alt="" style="width: 2rem;">
                        </div>
                        <nav style="list-style-type:none;">
                            <li class="list-space-footer-2-3">
                                <a class="list-menu-footer-2-3">Beranda</a>
                            </li>
                            <li class="list-space-footer-2-3">
                                <a class="list-menu-footer-2-3">Kelas</a>
                            </li>
                            <li class="list-space-footer-2-3">
                                <a class="list-menu-footer-2-3">Guru</a>
                            </li>
                            <li class="list-space-footer-2-3">
                                <a class="list-menu-footer-2-3">Pendaftaran</a>
                            </li>
                            <li class="list-space-footer-2-3">
                                <a class="list-menu-footer-2-3">Informasi</a>
                            </li>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <h2 class="footer-text-title-footer-2-3 list-space-footer-2-3-title">TPQ</h2>
                    <nav style="list-style-type:none;">
                        <li class="list-space-footer-2-3">
                            <a class="list-menu-footer-2-3">Kelas</a>
                        </li>
                ...
                <div class="col-lg-3 col-md-6">
                    <h2 class="footer-text-title-footer-2-3 list-space-footer-2-3-title">Bantuan</h2>
                    <nav style="list-style-type:none;">
                        <li class="list-space-footer-2-3">
                            <a class="list-menu-footer-2-3">Informasi</a>
                        </li>
                        ...
                        <li class="list-space-footer-2-3">
                            <a class="list-menu-footer-2-3">Hubungi Kami</a>
                        </li>
                    </nav>
                </div>
            </div>
        ...
        <div class="border-color-footer-2-3 info-footer-footer-2-3">
            ...
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space-footer-2-3">
                ...
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                    <p style="margin: 0">Copyright © <?= date('Y'); ?> TPQ Alfatih</p>
                </nav>
            </div>
        </div>
    </div>
